-- Fix Demo Super Admin Navigation Issues
...
-- First, get the demo organization ID
DO $$
DECLARE
    demo_org_id uuid;
BEGIN
    ...
    WHERE domain = 'demo.com' OR name = 'Demo Organization'
    LIMIT 1;

    -- If demo org exists, enable features for it
    ...
    ELSE
        RAISE NOTICE 'Demo organization not found - please create it first using the demo user setup';
    END IF;
END $$;
